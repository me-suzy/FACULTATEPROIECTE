...
BEGIN
  ...
  -- ATENTIE ! Daca stergerea provine din declansatorul tabelei PERSONAL, nu 
  -- se mai face nici o verificare !!!
  IF DELETING AND pachet_salarizare.v_regula_del_personal <> 'C' THEN 
    BEGIN 
