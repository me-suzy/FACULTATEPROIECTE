 ...
 * ClientPro1.java
 *
 * Created on 24 martie 2003, 12:45
 */

package exemple.vizibilitateProtected.packSuper;
...
public class Super {
	...
	public void superToSub (Sub sub) {
		// i este Ok pentru cã este vorba de un membru public
		int i = sub.public_Sub_Field ;
		// j ºi k sunt invalide, accesul protected sau private este restricþionat
