/*
 * TestInnerPrivateClasses.java
 *
 * Created on 31 martie 2003, 12:40
 */
...
class ClasaExterna{
  ...
  private class ClasaInterna implements InterfaceInner {
...
public class TestInnerPrivateClasses{
  public static void main(String[] args) {
    ...
    // Instantierea clasei interne pentru a obtine o referinta tip InterfaceInner
    // nu este posibila datorita accesului privat
    // InterfaceInner i_ref1 = o_ext.new ClasaInterna();

    // Se poate obtine o referinta la interfata InterfaceInner prin intermediul
    // clasei interne folosind o metoda publica din clasa externa a carei
    // responsabilitate este sa instantieze clasa interna
    InterfaceInner i_ref = o_ext.referintaInterna();
    	// apelul metodei getm1 definitã în InterfaceInner ºi implementatã în ClasaInternã
