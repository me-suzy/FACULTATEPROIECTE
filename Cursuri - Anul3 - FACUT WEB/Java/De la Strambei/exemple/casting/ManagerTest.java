 ...
 * ManagerTest.java
 *
 * Created on 31 martie 2003, 11:28
 */

package exemple.casting;
...
public class ManagerTest {
  public static void main (String args[]){
    ...
    if (staff[1] instanceof Manager){
        m = (Manager)staff[1];
        System.out.println(m.getNumeSecretara());
    }
  }
}
...
class Angajat {
  ...
  public void crestereSalariu(double procent){
    ...
    salariu = (Math.round(salariu * 100))/100.0;
  }
...
class Manager extends Angajat{
  ...
  public void crestereSalariu(double procent){
    Data astazi = new Data(2004, 03, 25);
