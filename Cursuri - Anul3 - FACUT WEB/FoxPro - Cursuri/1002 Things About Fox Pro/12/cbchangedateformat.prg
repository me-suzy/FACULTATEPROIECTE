****************************************************************************
*
*  PROGRAM NAME: CBChangeDateFormat.prg
*
...
*
*  PROGRAM DESCRIPTION: 
*     This program changes the date displayed in the File Description frame
*     of the VFP Class Browser.  This add-in automatically loads when the 
*     Class Browser loads.
*
*  CALLED BY: 
*     DO CBChangeDateFormat                   && Registers in Browser.dbf
*     DO CBChangeDateFormat WITH <toBrowser>  && As called from Class Browser
*
*  SAMPLE CALL:
