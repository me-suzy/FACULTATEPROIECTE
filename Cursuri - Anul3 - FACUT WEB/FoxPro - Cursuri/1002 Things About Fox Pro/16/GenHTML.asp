...
Dim SoapServer
If Not Application("GenHTMLInitialized") Then
  Application.Lock
  If Not Application("GenHTMLInitialized") Then
    Dim WSDLFilePath
    Dim WSMLFilePath
    WSDLFilePath = Server.MapPath("GenHTML.wsdl")
    WSMLFilePath = Server.MapPath("GenHTML.wsml")
    ...
    Set Application("GenHTMLServer") = SoapServer
    Application("GenHTMLInitialized") = True
  End If
  Application.UnLock
End If
Set SoapServer = Application("GenHTMLServer")
