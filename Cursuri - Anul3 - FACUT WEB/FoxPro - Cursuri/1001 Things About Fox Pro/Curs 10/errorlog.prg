...
DEFINE CLASS xErrLog AS FormSet
    *** Set Protected Properties
    PROTECTED FormCount, Visible, DataSession, cAppName, cLogTo, nDSId
    PROTECTED cOldError, nErrNum, cErrText, cErrSce, cErrProg, nErrLine
    ...
    cAppName    = ""				&& Application Name
    cLogTo      = ""    			&& Path for Text File
    cLogFile    = ""                && File Name for Text File
        ...
        WITH This
            ...
            *** Look up the error in the message table
            IF SEEK( .nErrNum, 'ErrMsg', 'ErrNum' )
                ...
                .cErrAct = ALLTRIM( ErrMsg.ErrAction )
            ELSE
